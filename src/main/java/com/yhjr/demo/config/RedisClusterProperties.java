...
public class RedisClusterProperties {
    ...
    public String toString() {
        return "RedisClusterProperties [clusterNodes=" + clusterNodes + ", connectionTimeout=" + connectionTimeout
                + ", soTimeout=" + soTimeout + ", maxAttempts=" + maxAttempts + ", password=" + password
                + ", expireSeconds=" + expireSeconds + ", poolMaxWait=" + poolMaxWait + ", poolMaxIdle=" + poolMaxIdle
                + ", poolMaxActive=" + poolMaxActive + ", poolMaxTotal=" + poolMaxTotal + ", poolTestOnBorrow="
                + poolTestOnBorrow + ", poolMinEvictableIdleTimeMillis=" + poolMinEvictableIdleTimeMillis
                + ", poolTimeBetweenEvictionRunsMillis=" + poolTimeBetweenEvictionRunsMillis + "]";
    }
