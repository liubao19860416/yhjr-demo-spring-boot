...
public class LogRecordAspect {
    ...
    @Before(value="(execution(* com.yhjr.demo.controller..*.*(..))) ")  
	...
	@AfterReturning(value="(execution(* com.yhjr.demo.controller..*.*(..)))",argNames="joinPoint,retValue", returning="retValue")  
	public void after(JoinPoint joinPoint,Object retValue) {
		...
		if(generateUrlJson!=null&&LOGGER.isInfoEnabled()){
			LOGGER.info("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
